...
public class ClienteCRUD implements ICRUD{
	...
	public void cadastrar() {
		...
		System.out.print("Informe o numero do endere�o: ");
				...
				if (c.getCpf().equals(cpf)) {
					...
					while (true) {
						...
						if (campo.equalsIgnoreCase("NOME")) {
							...
							try {
								System.out.print("Informe o ID do numero para a atualiza��o: ");
								int match = input.nextInt();
								input.nextLine();
								String telefone;
								while (true) {
									try {
										System.out.print("Informe o telefone para a atualiza��o: ");
								...
								if (match < 0 || match >= telefones.size()) {
									System.out.println("ID INFORMADO � INVALIDO;");
								} else {
							...
							System.out.println("OP��O SEM CORRESPONDENCIA");
						}
					}
					System.out.print("Deseja manter as altera��es (S/N)? ");
					char manter = input.next().charAt(0);
					if(Character.toUpperCase(manter) == 'S') {
						cs.atualizarCliente(c);
						System.out.println("Cliente atualizado!");
					} else {
						System.out.println("OK. Os dados do cliente ser�o mantidos;");
					}
	...
	public void deletarTodos() {
		System.out.println("Essa � uma opera��o destrutiva do banco de dados;");
